      ...
      <div>
        ...
        <div className="relative">
          ...
          >
            <div
              id="arrow"
              className="cursor-pointer absolute lg:-left-20 top-60 z-30 transform -scale-x-100 max-lg:hidden"
            >
              <PrevButton />
            </div>
            <SwiperSlide>
            ...
            <div
              id="arrow"
              className="cursor-pointer absolute lg:-right-20 top-60 z-30 max-lg:hidden"
            >
              <NextButton />
            </div>
          </Swiper>
